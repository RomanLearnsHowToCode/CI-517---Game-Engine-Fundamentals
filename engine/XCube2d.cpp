...
XCube2Engine::XCube2Engine() {
	...
	// initialise AchievementsEngine subsystem
#ifdef _DEBUG
	debug("AchievementEngine() successful");
#endif

	achievementsInstance = std::shared_ptr<AchievementsEngine>(new AchievementsEngine());
}
